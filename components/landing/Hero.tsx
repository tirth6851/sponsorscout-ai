...
import { ArrowRight, Shield, Clock, Target, CheckCircle2 } from 'lucide-react';
    ...
    <div className="glass-card rounded-2xl p-5 w-full max-w-sm animate-float shadow-glow-blue">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-[#0078d4] flex items-center justify-center text-xs font-bold text-white">MS</div>
          <div>
            <p className="text-sm font-semibold text-white leading-tight">Software Engineer II</p>
      ...
      <div className="flex flex-wrap gap-1.5 mb-4">
        ...
        <span className="inline-flex items-center gap-1 text-[10px] font-medium px-2 py-0.5 rounded-full bg-cyan-500/15 text-cyan-400 border border-cyan-500/20">
          <CheckCircle2 size={10} /> OPT OK
        </span>
      </div>

      {/* Insight */}
      <p className="text-[11px] text-slate-400 leading-relaxed border-t border-white/[0.06] pt-3">
        8+ consecutive years of H-1B sponsorship. Your MS in CS aligns strongly with the JD.
      </p>
...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] glow-orb-purple animate-glow opacity-30 translate-y-1/3" style={{ animationDelay: '2s' }} />
      <div className="absolute top-1/2 left-0 w-[300px] h-[300px] glow-orb-cyan animate-glow opacity-20" style={{ animationDelay: '1s' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass border border-blue-500/20 text-xs text-blue-400 font-medium mb-6 animate-fade-in">
              ...
              Built for International Students · Powered by Claude AI
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.07] tracking-tight text-white mb-6">
              ...
              <span className="gradient-text block sm:inline">
                with Visa Intelligence
              </span>
            </h1>

            {/* Subtitle */}
            <p className="text-lg text-slate-400 leading-relaxed max-w-xl mb-8">
              SponsorScout AI is the only career navigator that reasons about your CPT/OPT timeline, sponsorship needs, and strategic goals — turning a confusing job market into a clear, prioritized action plan.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-6 text-sm text-slate-500">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Priority-ranked matches</span>
              </div>
              <div className="flex items-center gap-2">
