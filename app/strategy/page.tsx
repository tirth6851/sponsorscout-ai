        ...
        <div className="container-max">
          <div className="mb-7">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass border border-purple-500/20 text-xs font-medium mb-3">
              <Sparkles size={12} className={generatedBy === 'claude' ? 'text-purple-400' : 'text-slate-500'} />
              <span className={generatedBy === 'claude' ? 'text-purple-400' : 'text-slate-500'}>
                {generatedBy === 'claude' ? 'Generated by Claude AI' : 'Algorithmic Strategy'}
              </span>
            </div>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-slate-500">
                          {generatedBy === 'claude' ? 'Claude AI · ' : 'Algorithmic · '}
